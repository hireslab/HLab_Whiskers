% trialContactBrowserBIG_VIEW is a tool to determine and examine whisking and contacts
%
% trialContactBrowserBIG_VIEW(array) will construct an first pass estimate of
% contacts using default parameters.
%
% trialContactBrowserBIG_VIEW(array, contacts) will load the browser with the
% contact info specified in the contacts structure, but default detection
% parameters.
%
% trialContactBrowserBIG_VIEW(array, contacts, params) will load the browser with
...
function trialContactBrowserBIG_VIEW(array, contacts, params, varargin)
...
if nargin <4
    ...
    set(fbutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''next'')'])
    set(bbutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''last'')'])
    set(abutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''add'')'])
    set(dbutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''del'')'])
    set(rbutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''recalc'')'])
    set(sbutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''save'')'])
    set(vbutton,'ClickedCallback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''videoOn'')'])
    
    set(flagToggle,'OnCallback',   ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''flagOn'')'])
    set(flagToggle,'OffCallback',  ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''flagOff'')'])
    set(floatToggle,'OnCallback',  ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''floatOn'')'])
    set(floatToggle,'OffCallback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''floatOff'')'])
    set(zoomToggle,'OnCallback',   ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''zoomOut'')'])
    set(zoomToggle,'OffCallback',  ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''zoomIn'')'])
    
    % Setup menus
    m1=uimenu(hParamBrowserGui,'Label','Time Period','Separator','on');
    uimenu(m1,'Label','All'                          ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''all'')']);
    uimenu(m1,'Label','Contacts Only'                ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''contactsOnly'')']);
    uimenu(m1,'Label','Exclude Contacts'             ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''excludeContacts'')']);
    uimenu(m1,'Label','Pole Presentation to Decision','Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''poleToDecision'')']);
    uimenu(m1,'Label','First Contact to Decision'    ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''contactToDecision'')']);
    uimenu(m1,'Label','Post Decision'                ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''postDecision'')']);
    uimenu(m1,'Label','Post Pole'                    ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''postPole'')']);
    uimenu(m1,'Label','Abritrary Range'              ,'Callback', ['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''arbitrary'')']);
    
    m2=uimenu(hParamBrowserGui,'Label','Adjust parameters','Separator','on');
    uimenu(m2,'Label','Plots'   ,'Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''adjPlots'')']);
    uimenu(m2,'Label','Spikes'  ,'Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''adjSpikes'')']);
    uimenu(m2,'Label','Contacts','Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''adjContacts'')']);
    uimenu(m2,'Label','Trial Range','Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''adjTrials'')']);
    
    uimenu(hParamBrowserGui,'Label','Jump to sweep','Separator','on','Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''jumpToSweep'')']);
    ...
    %     uimenu(m3,'Label','STA'     ,'Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''STA'')']);
    %     uimenu(m3,'Label','Clusts'  ,'Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''clusts'')']);
    %     uimenu(m3,'Label','Tuning'  ,'Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''tuning'')']);
    %     uimenu(m3,'Label','Contacts','Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''contacts'')']);
    %     uimenu(m3,'Label','Fit'     ,'Callback',['trialContactBrowserBIG_VIEW(' params.arrayname ',' params.contactsname ', params,''fit'')']);
    %
    %
...
%                 hParamBrowserGui.Children(8).Children(2).YData
            ...
            case 'add'
                ...
                tmpIND = SPinds(1:90, 1:99);
                hs_1 = subplot(100,100,tmpIND(:));
                params.xlim =  get(subplot(100,100,tmpIND(:)),'xlim');
                params.ylim =  get(subplot(100,100,tmpIND(:)),'ylim');
...
if isempty(cW)==1
    ...
    hs_2 = subplot(100,100,tmpIND(:));hold off;
    ...
    subplot(100,100,tmpIND(:));hold off;
